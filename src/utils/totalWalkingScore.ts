...
export default function totalWalkingScore( { tempScore, humidityScore, windScore, pm10Score, pm25Score }: totalWalkingScoreProps) {
  ...
  return Math.round(tempEvaluation + humidityEvaluation + windEvaluation + pm10Evaluation + pm25Evaluation)
};
